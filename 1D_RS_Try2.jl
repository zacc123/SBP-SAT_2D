...
global const year_seconds::Int64 = 31556926
...
function main()
    ...
    # create operators
    (A, B, H̃, T, e) = get_operators(SBPp, Nx, μ; xc = xc)
    ...
    bdry_vec_strip!(b, B, x, δ ./ 2, (t .* Vp./2)*ones(1), zeros(size(x)), Lx)
